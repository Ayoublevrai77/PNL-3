...
client.giveawaysManager.on("giveawayReactionAdded", (giveaway, member, reaction) => {
  console.log(`${member.user.tag} entrée giveaway #${giveaway.messageID} (${reaction.emoji.name})`);
});

client.giveawaysManager.on("giveawayReactionRemoved", (giveaway, member, reaction) => {
  console.log(`${member.user.tag} n'as pas réagis à la réaction #${giveaway.messageID} (${reaction.emoji.name})`);
});
...
if (!isNaN(messages)) {
    ...
    let levelembed = new Discord.MessageEmbed()
        ...
        .setFooter(`${prefix}offxp Pour désactiver les messages des niveaux`)
